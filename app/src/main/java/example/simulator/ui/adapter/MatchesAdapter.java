package example.simulator.ui.adapter;
...
import example.simulator.databinding.MatchItemBinding;
import example.simulator.domain.Match;
import example.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        Glide.with(context).load(match.getHomeTeam().getImage()).circleCrop().into(viewHolder.binding.ivHomeTeam);
        ...
        Glide.with(context).load(match.getAwayTeam().getImage()).circleCrop() .into(viewHolder.binding.ivAwayTeam);
